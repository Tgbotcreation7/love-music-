...
buttons = [
    [
        InlineKeyboardButton(
            text="🥺 ᴀᴅᴅ ᴋᴀʀʟᴏ ɴᴀ ʏᴀᴀʟ 🥺",
            url=f"https://t.me/{BOT_USERNAME}?startgroup=true",
        ),
    ],
    [
        InlineKeyboardButton(text="😍 ᴍᴀɴᴀɢᴍᴇɴᴛ ᴄᴏᴍɴᴅs 😍", callback_data="help_back"),
    ],
    [
    ...
    if update.effective_chat.type == "private":
        if len(args) >= 1:
            ...
            update.effective_message.reply_sticker(
                "CAACAgUAAx0CZIiVngABBE8-YwN8S0FP3luFg83xrBeXRmWKsDQAAgkKAAKVIyFUtMif4affRL4pBA"
            )
            update.effective_message.reply_text(
        ...
        update.effective_message.reply_photo(
            START_IMG,
            caption="ᴍᴀɪɴ ᴊɪɴᴅᴀ ʜᴜᴜ ʏᴀᴀʟ !\n<b>ᴍᴀɪɴ ɪs ᴛɪᴍᴇ sᴇ sᴏɪ ʜɪ ɴʜɪ​:</b> <code>{}</code>".format(
                uptime
            ),
...
def Fallen_about_callback(update: Update, context: CallbackContext):
    ...
    if query.data == "fallen_":
        ...
        query.message.edit_text(
            text=f"*ʜᴇʏ,*🥀\n  *ᴍᴀɪɴ ᴀᴀᴘᴋɪ {BOT_NAME}*"
            "\n*ᴍᴀɪɴ ᴍᴜsɪᴄ ʀᴏʙᴏᴛ ʜᴜ ᴀᴀᴘᴋᴇ ᴘʏᴀᴀʟᴇ ᴄʜᴇ ɢᴜʟᴜᴘ ᴋᴏ ʙᴀᴄʜᴜɴɢɪ ɢɴɴᴇ ʟᴏɢ sᴇ ᴀᴜʀ sᴘᴀᴍᴍᴇʀs sᴇ ʙʜɪ sᴀᴀᴛʜ ᴍᴇ ᴍᴜsɪᴄ ʙʜɪ ʙᴀᴊᴀᴜɴɢɪ*"
...
/playforce or /vplayforce or /cplayforce - ғᴏʀᴄᴇ ᴘʟᴀʏ sᴛᴏᴘs ᴛʜᴇ ᴄᴜʀʀᴇɴᴛ ᴘʟᴀʏɪɴɢ ᴛʀᴀᴄᴋ ᴏɴ ᴠᴏɪᴄᴇ ᴄʜᴀᴛ ᴀɴᴅ sᴛᴀʀᴛs ᴘʟᴀʏɪɴɢ ᴛʜᴇ sᴇᴀʀᴄʜᴇᴅ ᴛʀᴀᴄᴋ ɪɴsᴛᴀɴᴛʟʏ ᴡɪᴛʜᴏᴜᴛ ᴅɪsᴛᴜʀʙɪɴɢ/ᴄʟᴇᴀʀɪɴɢ ǫᴜᴇᴜᴇ.
...
def donate(update: Update, context: CallbackContext):
    ...
    if chat.type == "private":
        ...
        if OWNER_ID != 5102983667 and DONATION_LINK:
            update.effective_message.reply_text(
                f"» ᴛʜᴇ ᴅᴇᴠᴇʟᴏᴩᴇʀ ᴏғ {BOT_NAME} sᴏʀᴄᴇ ᴄᴏᴅᴇ ɪs [ᴛᴇᴀᴍ Sᴜᴋᴜɴ](https://t.me/sukunsupports)."
